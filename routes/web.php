...
Route::prefix('v2')->group(function () {
    Route::prefix('backend')->group(function () {
        ...
        Route::prefix('static')->group(function () {
            Route::controller(SoccerController::class)->name('static.')->group(function () {
                Route::get('soccer', 'soccer')->name('soccer');   // /v2/backend/soccer/index
                Route::get('cricket', 'cricket')->name('cricket');   // /v2/backend/circeket/index
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::prefix('admin')->group(function () {
            ...
            //         Route::get('show-Form', 'create')->name('store');
            //         Route::post('store', 'store')->name('store');
...
Route::get('/static-order', [StaticController::class, 'staticOrdershow'])->name('static.order');
