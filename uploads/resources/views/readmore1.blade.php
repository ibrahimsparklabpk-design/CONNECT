        ...
        <div class="readmore-right" class="company-box">
            ...
            <div class="custom-box1">
                <button class="share-button" onclick="toggleSharePopup()">
                    <img src="/assets/shareiconwhite.png" alt="Share" style="width: 30%;" />
                    <span>Share</span>
                </button>
 ...
 <div class="review-box">
                    ...
                    <form class="comment_form" action="{{ route('comments.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="review_title" class="form-control" id="review_title" required>
                        </div>
                        <div class="mb-3">
                            <label for="review_description" class="form-label">Review
                                Description</label>
                            <textarea name="review_description" class="form-control" id="review_description" rows="4"
                                required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="date_of_experience" class="form-label">Date of
                                Experience</label>
                            <input type="date" name="date_of_experience" class="form-control" id="date_of_experience"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary commentBtn">Submit Review</button>
                    </form>
                </div>
