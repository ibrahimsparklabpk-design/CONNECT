...
<head>
    ...
    <link rel="stylesheet" href="assets/showDirectories/styles.css">
     ...
     <link rel="stylesheet" href="assets/css/loginFormCss.css">
 ...
 <link href="https://fonts.googleapis.com/css2?family=Karla:ital,wght@0,200..800;1,200..800&display=swap" rel="stylesheet">
    ...
    <!--favicon-->
          ...
          <!-- Add intl-tel-input CSS for popup  -->
...
<body>
    ...
    <div>
        ...
        <div class="login-box" style="  background: linear-gradient(315deg, #E4F1EE 3%, #E5E4F0 38%, #DBEBEB 68%, #E5ECF1 98%);margin-top:-195px">
