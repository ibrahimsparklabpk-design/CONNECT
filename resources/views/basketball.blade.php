    ...
    <form action="{{ route('add_to_cart') }}" method="POST">
        ...
        <div class="flex-form">
            ...
            <div class="form-column">
                ...
                <!-- Price chage script -->
                <!-- JavaScript to handle price calculation -->
                <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                <script>
                $(document).ready(function() {
                    // Initial base price from the hidden input
                    let basePrice = parseFloat($('#base-price').val()) || 39.00; // Default to 39.00

                    // Function to update the displayed price
                    function updatePrice() {
                        // Get selected prices from dropdowns using data-price attribute
                        ...
                        let logoPrice = parseFloat($('#team-logo option:selected').data('price')) || 0;
                        let messagePrice = parseFloat($('#inside-collar-message option:selected').data(
                            'price')) || 0;

                        // Calculate the total price
                        let totalPrice = basePrice + sleevePrice + collarPrice + logoPrice + messagePrice;
                    ...
                    // Call updatePrice on page load to initialize displayed price
                    updatePrice();

                    // Event listeners for dropdown changes
                    $('#sleeve-length, #collar-type, #team-logo, #inside-collar-message').change(function() {
                        updatePrice(); // Call updatePrice function whenever a dropdown changes
                    });
                });
                </script>
            ...
            <div class="form-column">
                <div class="form-group">
                    ...
                    <select id="team-logo" name="team-logo">
                        ...
                        <option value="sublimated" data-price="0">Sublimated (Printed)</option>
                        <option value="embroidered" data-price="1">Embroidery $1.00</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="inside-collar-message" name="inside-collar-message">
                        ...
                        <option value="yes" data-price="2">Yes $2.00</option>
        ...
        <div class="team-form-container">
            ...
            <table class="team-roster-table">
                ...
                <tbody>
                    <!-- Repeatable Rows -->
                    <tr>
                        <td><input type="text" class="fi-name" placeholder="--" name="name[]" /></td>
                        <td><input type="text" class="fi-number" placeholder="--" name="number[]" /></td>
                        <td>
                        ...
                        <td class="pants-size-td">
                            <select class="pants size" name="short_size[]">
                                <option value="">--</option>
                                <option value="youth-xs">Youth XS</option>
                                <option value="youth-s">Youth S</option>
                                <option value="youth-m">Youth M</option>
