...
@section('main-content')
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6">
                    <div class="main-section" style="display: flex; gap: 30px;">
                              ...
                              <div class="tabcontent" id="Logos" style="display: none">
                                ...
                                <div class="tabcontent" id="Patterns" style="display: none">
                                    <div class="pattern-container">
                                          <div style=" 20px; display: flex; align-items: center; gap: 10px; justify-content: center">
                        ...
                        <h2 style="font-weight:700; font-size:20px; margin-bottom:25px; color:#222; text-align:center;">
                        ...
                        <div style="background:#f9f9f9; padding:15px; border-radius:12px; margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:12px;">
                                <label style="display:block; font-size:13px; font-weight:500; margin-bottom:6px; color:#555;">Name Color</label>
                            ...
                            <div>
                                <label style="display:block; font-size:13px; font-weight:500; margin-bottom:6px; color:#555;">Number Color</label>
                        ...
                        <div style="background:#f9f9f9; padding:15px; border-radius:12px; margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:12px; display:flex; gap:10px; align-items:center;">
                                <input type="text" id="sleeve-text-left" placeholder="Sleeve Left" maxlength="10"
                            ...
                            <div style="margin-bottom:12px; display:flex; gap:10px; align-items:center;">
                                <input type="text" id="sleeve-text-right" placeholder="Sleeve Right" maxlength="10"
                                    style="flex:1; padding:8px 10px; border-radius:8px; border:1px solid #ccc; font-size:13px;" />
    ...
    <h3 style="font-size:16px; font-weight:600; margin-bottom:15px; color:#333;">Upload Logos</h3>
    ...
    <div id="playerLogos" style="margin-top: 1rem; text-align: center;">
        ...
        <div id="player-logo-container" style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 15px; justify-content: center;"></div>
    </div>
</div>
                    </div>
