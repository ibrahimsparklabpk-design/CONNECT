                ...
                <div class="left-section" style="min-width: 300px; ">
                    <div class="icon-list" style="display: flex; gap: 10px; margin-bottom: 20px;">
                        <div class="icon" onclick="openTab('categories')">
                            <img src="{{ asset('/') }}assets/categories-icon.png" alt="Categories Icon" class="tab-icon"
                                width="50px" />
                        </div>
                        ...
                        <div class="icon" onclick="openTab('Patterns')">
                            <img src="{{ asset('/') }}assets/pattern-icon.png" alt="Patterns Icon" class="tab-icon"
                                width="50px" />
                        </div>
                        <div class="icon" onclick="openTab('uploadPatterns')">
                            <img src="{{ asset('/') }}assets/Patterns-Icon.png" alt="Patterns Icon" class="tab-icon"
                                width="50px" />
                        </div>
                    ...
                    <div class="items-list" style="  height: 40rem;">
                        <div class="tabcolor" id="colorpicker" style="display: none">
                            <div class="tabcontent" id="Shirts"
                                ...
                                <p style="font-weight: 600; font-size: 16px; margin-bottom: 15px;">Select shirt options
                                    here...</p>
                        ...
                        <div class="tabcontent" id="Logos" style="display: none">
                            <div class="logos-container">
                                <img src="{{ asset('/') }}assets/Logos/p-logo1.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo1.png')" alt="Logo 1" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo2.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo2.png')" alt="Logo 2" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo3.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo3.png')" alt="Logo 3" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo4.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo4.png')" alt="Logo 4" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo5.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo5.png')" alt="Logo 5" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo6.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo6.png')" alt="Logo 6" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo7.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo7.png')" alt="Logo 7" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo8.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo8.png')" alt="Logo 8" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo9.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo9.png')" alt="Logo 9" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo10.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo10.png')" alt="Logo 10" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo11.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo11.png')" alt="Logo 11" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo12.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo12.png')" alt="Logo 12" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo13.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo13.png')" alt="Logo 13" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo14.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo14.png')" alt="Logo 14" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo15.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo15.png')" alt="Logo 15" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo16.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo16.png')" alt="Logo 16" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo17.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo17.png')" alt="Logo 17" />
                                <img src="{{ asset('/') }}assets/Logos/p-logo18.png" class="logo"
                                    onclick="selectLogo('{{ asset('/') }}assets/Logos/p-logo18.png')" alt="Logo 18" />
                            </div>
                        </div>
                        ...
                        <div class="tabcontent" id="Patterns" style="display: none">
                            <div class="pattern-container">
                                <img src="{{ asset('/') }}assets/soccer-shirts/pattern1.png" class="Patterns"
                                    onclick="selectPattern('{{ asset('/') }}assets/soccer-shirts/pattern1.png')"
                                    alt="Pattern 1" />
...
const colors = { collar:"#ffffff", body:"#ffffff", sleeve:"#ffffff", trouser:"#ffffff", pattern:"#ffffff" };
...
function setupColorPickers(){
    ["collar","body","sleeve","trouser","pattern"].forEach(p=>{
