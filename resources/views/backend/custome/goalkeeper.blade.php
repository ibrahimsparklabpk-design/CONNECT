...
<div class="container-fluid">
                            ...
                            <div class="items-list" style="  height: 40rem;">
                                  ...
                                  <div class="tabcontent" id="Shirts" style="display:none; padding: 15px; font-family: 'Karla', sans-serif;">
                                    ...
                                    <label class="color-picker-label" for="color-collar" style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
                                      <span style="width: 140px; font-weight: 500;">Collar Color:</span>
                                    ...
                                    <label class="color-picker-label" for="color-body" style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
                                      <span style="width: 140px; font-weight: 500;">Shirt Color:</span>
                                    ...
                                    <label class="color-picker-label" for="color-sleeve" style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
                                      <span style="width: 140px; font-weight: 500;">Sleeve Color:</span>
                                    ...
                                    <label class="color-picker-label" for="color-trouser" style="display:flex; align-items:center; gap:10px;">
                                      <span style="width: 140px; font-weight: 500;">Shorts Color:</span>
    ...
    <!-- Base hidden images -->
    <img id="shirt-collar" src="{{ asset('assets/goalkeeper/collors.png') }}" style="display: none" alt="collar" />
    <img id="shirt-body" src="{{ asset('assets/goalkeeper/shirt front and back.png') }}" style="display: none" alt="body" />
    <img id="shirt-sleeve" src="{{ asset('assets/goalkeeper/strips.png') }}" style="display: none" alt="sleeve" />
    <img id="shirt-trouser" src="{{ asset('assets/goalkeeper/trowser.png') }}" style="display: none" alt="trouser" />
