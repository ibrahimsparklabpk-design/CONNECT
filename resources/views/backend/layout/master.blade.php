...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="logo">
            ...
            <!--<img src="assets/connect1.png" style="width:140px">-->
            <img src="assets/logo.png" style="width:85px;">
                ...
                <div class="tabcontent" id="categories" style="display: none">
                    ...
                    <div class="cat-row ">
                        <div class="cat-col">
                            ...
                            <a href="soccer"><img src="./assets/soccer-icon.png" />
                            </a>
                            <h1>
                                soccer
                            </h1>
                        ...
                        <div class="cat-col">
                            ...
                            <a href="cricket"><img src="./assets/Cricketkit.png" />
                            </a>
                            <h1>
                                Cricket
                            </h1>
                        ...
                        <div class="cat-col">
                            ...
                            <a href="basketball"><img src="./assets/basketball-kit.png" />
                            </a>
                            <h1>
                                Basketball
                            </h1>
                    ...
                    <div class="cat-row ">
                        <div class="cat-col">
                            ...
                            {{-- <a href="goalkeeper"><img src="./assets/goalkeeper-1.png" /> --}}
                            </a>
                            <h1>
                                Goal Keeper
                            </h1>
                        ...
                        <div class="cat-col">
                            ...
                            {{-- <a href="staffmanagment"><img src="./assets/sfat-managment12.png" /> --}}
                            </a>
                            <h1>
    ...
    <form action="{{ route('soccer.store') }}" method="POST">
        ...
        <div class="flex-form">
            ...
            <div class="form-column">
                ...
                <!--    <option value="Mix" data-price="3">Mix</option>-->
                <!--</select>-->
                <div class="form-group">
                    ...
                    <!--        <option value="polo-style" data-price="1">Polo Style $2.00/Per Kit</option>-->
                    <!--    </select>-->
                    <!--</div>-->
                    <!-- Price chage script -->
                    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                    ...
                    <div class="message-group" id="message-group" style="display: none;">
                        ...
                        <!-- <textarea id="inside-collar-text" name="inside_collar_message_text" rows="4" cols="36" require></textarea> -->
            ...
            <table class="team-roster-table">
                ...
                <tbody id="table-body">
                    <tr>
                        ...
                        <td><input type="text" class="fi-number" name="number" placeholder="--" required />
                        </td>
                        ...
                        <td><input type="number" class="Quantity-input" name="quantity" placeholder="0"
                                min="1" required /></td>
                        <td>
